...
globalThis.__dirname = __filename.slice(0, __filename.lastIndexOf("/"));
...
export { Ammo, AnimatorRigidPhysicsBody, CreaturePackage, CreaturePlayer, EFK, FMOD, FrameEvent, Global, ImmediateEvent, RekapiActor, SS6Player, SS6PlayerInstanceKeyParam, SS6Project, initEffekseer };
